...
public class ServerWorker {
    ...
    public static void agentProfile(AppCompatActivity activity, String id){
        ServerTask tsk = new ServerTask(activity,new Handler());
        tsk.execute(Constants.AGT_PROFILE_METHOD, id);
    }

    public static void citizenProfile(AppCompatActivity activity, String id){
        ServerTask tsk = new ServerTask(activity,new Handler());
