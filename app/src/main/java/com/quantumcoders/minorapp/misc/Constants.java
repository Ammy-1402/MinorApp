...
public class Constants {
    ...
    public static final String SIGNUP_URL_CITIZEN = SERVER_URL + "/demoworkcitizen.php"; //demo php for citizen
    public static final String SIGNUP_URL_AGENT = SERVER_URL+"/demoworkagent.php"; //demo php for agent

    public static final String CTZ_SIGN_UP_METHOD="signUpCitizen";
    public static final String AGT_SIGN_UP_METHOD="signUpAgent";

    public static final String CTZ_SIGN_UP_SUCCESS="Success Citizen";
    public static final String AGT_SIGN_UP_SUCCESS="Success Agent";
}
